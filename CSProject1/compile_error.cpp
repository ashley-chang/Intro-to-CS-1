...
int main()
{
    ...
    cin << preferVanilla;       // Compilation error: Arrows pointing wrong way
    
    double pctChocolate = 100.0 * preferChocolate / numberSurveyed;
    double pctVanilla = 100.0 * preferVanilla / numbersurveyed;     // Compilation error: missing uppercase
    ...
    if (preferChocolate > preferVanilla)
        ...
        cout << "Vanilla is more popular than chocolate." << endl    // Compilation error: missing semicolon
